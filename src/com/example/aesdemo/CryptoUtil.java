 ...
 * 
 * @author rekygx@gmail.com (Xiang Gao)
 *
 */
public class CryptoUtil {
  ...
  BadPaddingException, UnsupportedEncodingException {
    System.out.println("Key in ENC: " + toHexString(secret));
    // Generate IV
    byte[] iv = generateIv();
    ...
    System.out.println("SecretKey in ENC: " + toHexString(secretKey1.getEncoded()));
    // Encrypt
  ...
  BadPaddingException, UnsupportedEncodingException, IllegalArgumentException {
    System.out.println("Key in DEC: " + toHexString(secret));
    ...
    System.arraycopy(secret, key1.length, key2, 0, key2.length);        
    SecretKey secretKey1 = new SecretKeySpec(key1, 0, key1.length, SECRET_KEY_ALGORITHM);
    System.out.println("SecretKey in DEC: " + toHexString(secretKey1.getEncoded()));
    // HMAC of encrypted text
    String hmac = hmac(encryptedText, key2, HMAC_KEY_ALGORITHM);
